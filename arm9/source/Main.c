...
//---------------------------------------------------------------------------------
	...
	REG_BG0CNT = BG_64x32 | BG_MAP_BASE(0) | BG_COLOR_16  | BG_TILE_BASE(2) | BG_PRIORITY(2);
	REG_BG1CNT = BG_64x32 | BG_MAP_BASE(2) | BG_COLOR_256 | BG_TILE_BASE(1) | BG_PRIORITY(2);
	...
	map0sub = (uint16 *)SCREEN_BASE_BLOCK_SUB(0);
	map1sub = (uint16 *)SCREEN_BASE_BLOCK_SUB(1);
