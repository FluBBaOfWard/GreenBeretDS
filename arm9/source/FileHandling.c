...
int loadSettings() {
	...
	g_dipSwitch2 = cfg.dipSwitchGB2;
	g_dipSwitch3 = cfg.dipSwitchGB3;
...
void saveSettings() {
	...
	cfg.dipSwitchGB0 = g_dipSwitch0;
	cfg.dipSwitchGB1 = g_dipSwitch1;
	cfg.dipSwitchGB2 = g_dipSwitch2;
	cfg.dipSwitchGB3 = g_dipSwitch3;
